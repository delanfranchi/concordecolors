...
export class SonicComponent extends LitElement {
  static styles = [
    ...
    css`
      ...
      sonic-theme {
        padding: 1rem clamp(3vw, 3vw, 3rem);
      }
    ...
    return html`
      ...
      <div class="flex flex-wrap gap-x-10  gap-y-4" formDataProvider="themeSettings">
        ...
        <div class="grid gap-12">
          <div class="lg:my-10 flex  flex-wrap gap-5  items-end">
          ...
          ></sonic-theme-generator>
          <sonic-theme-preview class="mt-24 block bg-neutral-50 p-10 rounded-lg"></sonic-theme-preview>
        </div>
      </sonic-theme>
    `;
  }
